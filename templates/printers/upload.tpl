...
<br>	
<form method="post" action="/printers/upload">
...
<table cellpadding="4" style="background: #eee; border: 1px solid #ccc;">
	...
	<tr>
		...
		<td><input type="text" name="obsolete" id="obsolete"></td>
	...
	<tr>
		...
		<td><textarea name="description" id="discription" rows="6" cols="28"></textarea></td>
...
<table cellpadding="4" style="background: #eee; border: 1px solid #ccc;">
	<tr>
		...
		<td width="40%"><textarea name="supportdescription" id="supportdescription" rows="8" cols="28"></textarea></td>
...
<table cellpadding="4" style="background: #eee; border: 1px solid #ccc;">
	...
	<tr>
		...
		<td>
				...
				<input type="checkbox" name="color" id="color-02" value="0"> Greyscale
		</td>
		<td>Check this if the driver supports greyscale output</td>
	</tr>
	<tr>
